package com.example.pr3_module5.di

import android.content.Context
import com.example.pr3_module5.data.datasource.PhotoLocalDataSource
import com.example.pr3_module5.data.repository.PhotoRepositoryImpl
import com.example.pr3_module5.domain.repository.PhotoRepository
import com.example.pr3_module5.domain.usecase.ExportPhotoUseCase
import com.example.pr3_module5.domain.usecase.GetAllPhotosUseCase
import com.example.pr3_module5.domain.usecase.SavePhotoUseCase
